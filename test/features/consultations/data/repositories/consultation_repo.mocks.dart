...
// in tabibi/test/features/consultations/data/repositories/consultation_repo.dart.
...
class MockConsultationDS extends _i1.Mock implements _i2.ConsultationDS {
  ...
  _i3.Future<List<_i4.Consultation>> getConsultations() =>
      (super.noSuchMethod(Invocation.method(#getConsultation, []),
              returnValue:
  ...
  _i3.Future<List<_i4.Consultation>> getMyConsultatioins(String? userId) =>
      (super.noSuchMethod(Invocation.method(#getMyConsultatioin, [userId]),
              returnValue:
                  Future<List<_i4.Consultation>>.value(<_i4.Consultation>[]))
          as _i3.Future<List<_i4.Consultation>>);
  @override
  _i3.Future<List<_i4.Consultation>> getConsultationsBySpeci(
      ...
      (super.noSuchMethod(
              Invocation.method(#getConsultationBySpeci, [specialization]),
              returnValue:
                  Future<List<_i4.Consultation>>.value(<_i4.Consultation>[]))
          as _i3.Future<List<_i4.Consultation>>);
}
